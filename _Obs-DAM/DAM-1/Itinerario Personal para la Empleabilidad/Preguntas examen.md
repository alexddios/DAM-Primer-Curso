...
**1. Elementos del Ikigai** El _ikigai_ es un término japonés que representa nuestra razón de ser en el mundo. Se halla en la confluencia de cuatro elementos:

- Lo que amas (pasión)
- En lo que eres bueno (profesión)
...
**11. Hard skills y soft skills con ejemplo**

- **Hard skills**: habilidades técnicas o conocimientos específicos que se pueden demostrar y acreditar. _Ejemplo: saber programar en Python._
...
**14. Dos estrategias para proteger la identidad digital**

- **Usar contraseñas seguras y únicas para cada cuenta**, cambiándolas con frecuencia.
- **Utilizar autenticación de dos factores** cuando sea posible (por ejemplo, mediante contraseña y clave móvil).
[[U11-Proteccion-Identidad-Digital]]